...
const STYLES = {
  ...
  uploadCard: { background: '#eef1fc', border: '1px solid #c7d2fe', borderRadius: 12, padding: 16, marginBottom: 16 },
  uploadTitle: { fontWeight: 700, fontSize: 14, marginBottom: 10 },
  upRow: { display: 'flex', gap: 8, flexWrap: 'wrap', alignItems: 'center' },
  upBtn: { background: '#2d5be3', color: '#fff', border: 'none', borderRadius: 8, padding: '9px 14px', cursor: 'pointer', fontSize: 13, fontWeight: 600 },
  ...
  searchBtn: { background: '#2d5be3', color: '#fff', border: 'none', borderRadius: 9, padding: '10px 20px', fontWeight: 700, cursor: 'pointer', fontSize: 14, whiteSpace: 'nowrap' },
  ...
  detailBtn: { background: '#eef1fc', color: '#2d5be3', border: 'none', borderRadius: 7, padding: '5px 12px', cursor: 'pointer', fontSize: 12.5, fontWeight: 600, whiteSpace: 'nowrap' },

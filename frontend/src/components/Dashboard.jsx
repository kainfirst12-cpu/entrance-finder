...
const ACTIONS = [
  { key: 'form', icon: '✨', label: '새 분석', desc: '생기부 AI 분석 시작', color: '#5b86d6', bg: '#eaf1ff' },
  { key: 'assessment', icon: '📝', label: '수행평가 도우미', desc: '작성·첨삭·문서화', color: '#9070d8', bg: '#f4edff' },
  { key: 'chat', icon: '💬', label: '입시 상담', desc: 'AI에게 상담', color: '#46a571', bg: '#e9f7ee' },
  { key: 'admissions', icon: '🎓', label: '대학 입결 조회', desc: '정시·수시·논술 입결', color: '#e0993f', bg: '#fff4e6' },
  { key: 'list', icon: '👥', label: '학생 목록', desc: '저장된 분석 목록', color: '#5b86d6', bg: '#eaf1ff' },
  { key: 'import', icon: '📂', label: '분석 불러오기', desc: 'JSON 파일 열기', color: '#8a857c', bg: '#f3f1ee' },
];
...
const S = {
  ...
  h2: { fontSize: 24, fontWeight: 800, margin: '0 0 4px', color: '#1a1916' },
  lead: { color: '#6b6860', fontSize: 13.5, margin: '0 0 18px' },
  ...
  actionLabel: { fontSize: 15, fontWeight: 700, color: '#1a1916', marginTop: 4 },
  actionDesc: { fontSize: 12, color: '#6b6860' },
